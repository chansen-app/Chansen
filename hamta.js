...
const KATEGORIER = {
  ...
  "Lager och logistik": ["lager","terminal","plock","truck","gods","paket","distribution",
                         ...
                         "nattdistribut","tidningsutdel","packpersonal","varupafyll","varupåfyll",
                         "orderplock","godsmottag"],
  ...
  "Barn och skola": ["barn","fritids","forskola","förskola","elevassistent","skolmaltid","skolmåltid",
                     "laxhjalp","läxhjälp","laxlas","läxläs","studiehandled","skolvard","skolvärd",
                     "resurspedagog","fritidsledare","barnskotare","barnskötare","dagbarnvardare",
                     "dagbarnvårdare","simskola","babysim","lovaktivitet","kollo"],
  // Prövas efter Barn och skola, eftersom "elevassistent" innehåller
  // "assistent" och "skolvärd" innehåller "vård".
  "Vård och omsorg": ["personlig assistent","personliga assistent","assistent sokes",
                      "assistent sökes","assistenter sokes","assistenter sökes",
                      "vardbitrade","vårdbiträde","underskoterska",
                      "undersköterska","omsorg","hemtjanst","hemtjänst","boendestod",
                      "boendestöd","ledsagare","avlosare","avlösare","stodassistent",
                      "stödassistent","vardare","vårdare","aldreboende","äldreboende",
                      "sjukskoterska","sjuksköterska","habilitering","funktionsstod",
                      "funktionsstöd","serviceassistent"],
