...
const KATEGORIER = {
  // Ordningen avgör: den första som matchar vinner. Kategorier med
  // snäva, exakta ord ligger först så de inte körs över av bredare.
  // OBS: aldrig delsträngar som fastnar i ortsnamn. "stad" finns i
  // Karlstad, "skog" i Karlskoga och "stall" i timanställning.
  "Djur och natur": ["djurvard","djurvård","djurskot","djursköt","djurpassn","hundvakt",
    "hunddag","hundpassn","hundforare","hundförare","hastskot","hästsköt","stallskot",
    "stallsköt","stalljobb","ridskola","ridlarare","ridlärare","tradgardsarbet",
    "trädgårdsarbet","tradgardsmastare","trädgårdsmästare","parkarbet","parkskot","parksköt",
    "skogsarbet","skogsvard","skogsvård","lantbruk","vaxthus","växthus","gronytesk",
    "grönyteskö","zoo","veterinar","veterinär","lantarbet"],
  "Städ": ["stadning","städning","stadare","städare","staderska","städerska","stad/","städ/",
    "stad ","städ ","stada","städa","stadhjalp","städhjälp","stadpersonal","städpersonal",
    "husfru","housekeeping","lokalvard","lokalvård","cleaner","cleaning","fonsterputs",
    "fönsterputs","tvatt","tvätt","textilservice","hygien","sanering","skursk","hotellstad",
    "hotellstäd","rumsstad","rumsstäd","trappstad","trappstäd","hemstad","hemstäd","flyttstad",
    "flyttstäd","byggstad","byggstäd","kontorsstad","kontorsstäd","storstad ","storstäd "],
  ...
  "Lager och logistik": ["lager","terminal","plock","truck","gods","paket","distribution",
    ...
    "emballering","packning","truckforare","truckförare","nattdistribut","tidningsutdel",
    "packpersonal","varupafyll","varupåfyll","orderplock","godsmottag"],
  ...
  "Event och kultur": ["event","konferens","festival","biljett","garderob","bingo","mässa",
    "massa ","publikvard","publikvärd","arena","museum","bio ","teater","fritidsgård","camping",
    "badhus","simhall","skiduthyr","turism"]
};
